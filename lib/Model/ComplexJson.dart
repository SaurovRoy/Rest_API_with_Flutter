...
ComplexJson complexJsonFromJson(String str) => ComplexJson.fromJson(json.decode(str));
String complexJsonToJson(ComplexJson data) => json.encode(data.toJson());
class ComplexJson {
  ComplexJson({
      num? id, 
      String? name, 
